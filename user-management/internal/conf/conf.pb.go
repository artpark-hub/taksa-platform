...
type Data struct {
	...
	KratosAdminUrl  string                 `protobuf:"bytes,3,opt,name=kratos_admin_url,json=kratosAdminUrl,proto3" json:"kratos_admin_url,omitempty"`
	KratosPublicUrl string                 `protobuf:"bytes,4,opt,name=kratos_public_url,json=kratosPublicUrl,proto3" json:"kratos_public_url,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Data) GetKratosAdminUrl() string {
	if x != nil {
		return x.KratosAdminUrl
	}
	return ""
}

func (x *Data) GetKratosPublicUrl() string {
	if x != nil {
		return x.KratosPublicUrl
	}
	return ""
}
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x10kratos_admin_url\x18\x03 \x01(\tR\x0ekratosAdminUrl\x12*\n" +
	"\x11kratos_public_url\x18\x04 \x01(\tR\x0fkratosPublicUrl\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeoutB$Z\"user-management/internal/conf;confb\x06proto3"
