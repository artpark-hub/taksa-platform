...
const file_tenants_v1_tenants_proto_rawDesc = "" +
	"\n" +
	"\x18tenants/v1/tenants.proto\x12\x11usermanagement.v1\x1a\x1cgoogle/api/annotations.proto\"\x84\x01\n" +
	...
	"\tTokenData\x12\x1b\n" +
	"\tjwt_token\x18\x01 \x01(\tR\bjwtToken\"\xb6\x01\n" +
	...
	"first_name\x18\x03 \x01(\tR\tfirstName\x12\x1b\n" +
	"\tlast_name\x18\x04 \x01(\tR\blastName\x12+\n" +
	"\x11organization_name\x18\x05 \x01(\tR\x10organizationName\"O\n" +
	"\x1aRegisterMasterUserResponse\x121\n" +
	"\x04data\x18\x01 \x01(\v2\x1d.usermanagement.v1.TenantDataR\x04data\"r\n" +
	"\n" +
	"TenantData\x12\x1f\n" +
	"\videntity_id\x18\x01 \x01(\tR\n" +
	"identityId\x12+\n" +
	"\x11organization_name\x18\x02 \x01(\tR\x10organizationName\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status2\xff\a\n" +
	...
	"\vGetJWTToken\x12%.usermanagement.v1.GetJWTTokenRequest\x1a&.usermanagement.v1.GetJWTTokenResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/api/v1/um/token\x12\x9d\x01\n" +
	"\x12RegisterMasterUser\x12,.usermanagement.v1.RegisterMasterUserRequest\x1a-.usermanagement.v1.RegisterMasterUserResponse\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/api/v1/um/register_master_userB\"Z usermanagement/api/tenants/v1;v1b\x06proto3"
...
var file_tenants_v1_tenants_proto_goTypes = []any{
	...
	(*RegisterMasterUserRequest)(nil),  // 14: usermanagement.v1.RegisterMasterUserRequest
	(*RegisterMasterUserResponse)(nil), // 15: usermanagement.v1.RegisterMasterUserResponse
	(*TenantData)(nil),                 // 16: usermanagement.v1.TenantData
}
var file_tenants_v1_tenants_proto_depIdxs = []int32{
	...
	16, // 4: usermanagement.v1.RegisterMasterUserResponse.data:type_name -> usermanagement.v1.TenantData
	0,  // 5: usermanagement.v1.UserManagementService.CreateSubUser:input_type -> usermanagement.v1.CreateSubUserRequest
	2,  // 6: usermanagement.v1.UserManagementService.ListSubUsers:input_type -> usermanagement.v1.ListSubUsersRequest
	4,  // 7: usermanagement.v1.UserManagementService.DeleteSubUser:input_type -> usermanagement.v1.DeleteUserRequest
	4,  // 8: usermanagement.v1.UserManagementService.DeleteMasterUser:input_type -> usermanagement.v1.DeleteUserRequest
	6,  // 9: usermanagement.v1.UserManagementService.UpdateUserProfile:input_type -> usermanagement.v1.UpdateUserProfileRequest
	11, // 10: usermanagement.v1.UserManagementService.GetJWTToken:input_type -> usermanagement.v1.GetJWTTokenRequest
	14, // 11: usermanagement.v1.UserManagementService.RegisterMasterUser:input_type -> usermanagement.v1.RegisterMasterUserRequest
	1,  // 12: usermanagement.v1.UserManagementService.CreateSubUser:output_type -> usermanagement.v1.CreateSubUserResponse
	3,  // 13: usermanagement.v1.UserManagementService.ListSubUsers:output_type -> usermanagement.v1.ListSubUsersResponse
	5,  // 14: usermanagement.v1.UserManagementService.DeleteSubUser:output_type -> usermanagement.v1.DeleteUserResponse
	5,  // 15: usermanagement.v1.UserManagementService.DeleteMasterUser:output_type -> usermanagement.v1.DeleteUserResponse
	7,  // 16: usermanagement.v1.UserManagementService.UpdateUserProfile:output_type -> usermanagement.v1.UpdateUserProfileResponse
	12, // 17: usermanagement.v1.UserManagementService.GetJWTToken:output_type -> usermanagement.v1.GetJWTTokenResponse
	15, // 18: usermanagement.v1.UserManagementService.RegisterMasterUser:output_type -> usermanagement.v1.RegisterMasterUserResponse
