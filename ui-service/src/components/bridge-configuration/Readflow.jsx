...
const Readflow = ({ bridgeConfig, setBridgeConfig }) => {
    const [inputYaml, setInputYaml] = useState(defaultInputYaml);
    ...
    const [conditions, setConditions] = useState([
        { id: 1, condition: 'msg.meta.modbus_tag_name === "FirstFlagOfDiscreteInput"', action: 'msg.payload = Boolean(msg.payload);\nmsg.meta.unit = "bool";\nreturn msg;' },
        { id: 2, condition: 'msg.meta.modbus_tag_name === "ZeroElementOfInputRegister"', action: 'msg.payload = msg.payload;\nmsg.meta.unit = "raw";\nreturn msg;' }
    ]);
    const [defaultsCode, setDefaultsCode] = useState(`// This sample connects to a Modbus device and automatically configures the message with proper metadata.
...
${advancedProcessingCode.split('\n').map((line) => `  ${line}`).join('\n')}`;
    ...
    useEffect(() => {
        setProcessingCodeYaml(renderProcessingCodeView());
            ...
            <div className="bridge-readflow-section-card">
                <div className="bridge-processing-header">
                    <div className="bridge-processing-title">
                        ...
                        <p>Transform time-series data using the tag processor. Best for industrial equipment data with tag names, timestamps, and values. <button>View tag processor documentation</button></p>
                    </div>
                    ...
                    <div className="bridge-processing-code">
                        ...
                        >
                            ...
                            <textarea
                                ...
                                onBlur={() => setIsEditingProcessingCode(false)}
