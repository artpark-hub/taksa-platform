...
-- Action workflows: composite orchestration for facade deploy + configure
...
-- Device topics: materialized UNS topic catalog from StatusMessage core.topicBrowser (UnsBundle protobuf).
