...
func wireApp(serverConf *conf.Server, dataConf *conf.Data, deploymentConf *conf.Deployment, statusSub biz.StatusSubscriptionSettings, actionCleanup biz.ActionCleanupSettings, logger log.Logger, zapLogger *zap.Logger) (*kratos.App, func(), error) {
